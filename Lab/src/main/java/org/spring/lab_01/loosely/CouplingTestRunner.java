...
public class CouplingTestRunner
    ...
    public static void main(String[] args)
        ...
        System.out.println(balanceService.check(customerBalance,BigDecimal.valueOf(50)));
        ...
        System.out.println(balanceService.check(giftCardBalance,BigDecimal.valueOf(50)));
